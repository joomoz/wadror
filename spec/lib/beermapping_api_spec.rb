...
describe "BeermappingApi" do
  ...
  describe "in case of cache hit" do
    ...
    it "When one entry in cache, it is returned" do
      ...
      stub_request(:get, /.*testcity/).to_return(body: canned_answer, headers: {'Content-Type' => "text/xml"})

      # ensure that data found in cache
      BeermappingApi.places_in("testcity")

      places = BeermappingApi.places_in("testcity")
  ...
  it "When HTTP GET doesn't return any entries, an empty array is returned" do
  ...
  it "When HTTP GET returns many entries, all are given in an array" do
